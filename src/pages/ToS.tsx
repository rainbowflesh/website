...
export const TermOfService = () => {
  return (
    <div className="dot-background dark:dot-background-dark p-8 flex-1">
      <Hero className="w-4/5 bg-slate-50 dark:bg-base-200 m-auto rounded-box">
        <Hero.Content>
          <div className="leading-loose">
            <h1 className="text-3xl leading-10 font-bold">Terms and Conditions</h1>
            <p className="text-sm">Last updated: July 04, 2024</p>
            <p>Please read these terms and conditions carefully before using Our Service.</p>
            <h2 className="text-2xl leading-10 font-bold">Interpretation and Definitions</h2>
            <h3 className="text-xl leading-10 font-bold">Interpretation</h3>
            <p>
              The words of which the initial letter is capitalized have meanings defined under the following conditions.
              The following definitions shall have the same meaning regardless of whether they appear in singular or in
              plural.
            </p>
            <h3 className="text-xl leading-10 font-bold">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ZEEWIND Inc.,
                  深圳市龙岗区龙岗街道南联社区宝龙五巷10号8313.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to ZEEWIND UAV, accessible from
                  <a href="https://www.zeewind-uav.com" rel="external nofollow noopener" target="_blank">
                    https://www.zeewind-uav.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <h2 className="text-2xl leading-10 font-bold">Acknowledgment</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Links to Other Websites</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Termination</h2>
            <p>
              We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
              whatsoever, including without limitation if You breach these Terms and Conditions.
            </p>
            <p>Upon termination, Your right to use the Service will cease immediately.</p>
            <h2 className="text-2xl leading-10 font-bold">Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Governing Law</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Disputes Resolution</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">For European Union (EU) Users</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">United States Legal Compliance</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Severability and Waiver</h2>
            <h3 className="text-xl leading-10 font-bold">Severability</h3>
            <p>
            ...
            <h3 className="text-xl leading-10 font-bold">Waiver</h3>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Translation Interpretation</h2>
            <p>
              These Terms and Conditions may have been translated if We have made them available to You on our Service.
              You agree that the original English text shall prevail in the case of a dispute.
            </p>
            <h2 className="text-2xl leading-10 font-bold">Changes to These Terms and Conditions</h2>
            <p>
            ...
            <h2 className="text-2xl leading-10 font-bold">Contact Us</h2>
            <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
            <ul>
              <li>By email: contact@zeewind-uav.com</li>
            </ul>
          </div>
        </Hero.Content>
      </Hero>
