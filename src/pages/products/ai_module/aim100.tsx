...
export const AIModuleAim100 = () => {
  const { t } = useTranslation();
  const specs = [
    { name: t("string.ptz"), description: t("product.ai_module.aim100.ptz", { returnObjects: true }) },
    {
      name: t("string.visible_light_camera"),
      description: t("product.ai_module.aim100.vll", { returnObjects: true }),
    },
    { name: t("string.infrared_camera"), description: t("product.ai_module.aim100.irl", { returnObjects: true }) },
    { name: t("string.env_adapt"), description: t("product.ai_module.aim100.env_adapt", { returnObjects: true }) },
    { name: t("string.weight"), description: t("product.ai_module.aim100.weight") },
    { name: t("string.tdp"), description: t("product.ai_module.aim100.tdp") },
  ];
  const features: Array<any> = t("product.ai_module.aim100.features", { returnObjects: true });
  return (
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-12 sm:px-6 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div className="-mt-5 bg-white dark:bg-base-100 rounded-box">
          <div className="textbox mt-4 mr-4 mb-4 ml-4">
            ...
            <p className="pt-4 pb-4 text-lg text-gray-500 dark:text-gray-400 ">{t("product.ai_module.aim100.name")}</p>
            <p>{t("product.ai_module.aim100.introduce")}</p>
            <br />
            <p>{t("product.ai_module.aim100.application_scenario")}</p>
            <div className="border-t border-gray-200 pt-2 mt-8">
              ...
              <dd className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                {t("product.ai_module.aim100.system_components")}
              </dd>
            </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:gap-8 relative overflow-hidden">
          <img
            src="/images/ai_module/aim100/cover.png"
